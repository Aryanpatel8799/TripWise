  ...
  return (
    <div className="font-poppins bg-primary">
      ...
      <main className="flex flex-col items-center text-center py-12 px-6 gap-8">
        ...
        <Link to="/itinerary/ItineraryForm">
          <button
            id="itinerary-button"
        ...
        <p id="itinerary-desc" className="text-gray-700 max-w-2xl mx-auto mt-4">
          Let TripWise's AI-powered planner help you build the perfect itinerary
          for your next adventure, whether it's a vacation, workation, or
          spontaneous getaway.
        </p>
      </main>
      ...
      <section className="px-6 py-12">
        <h2 className="text-xl md:text-2xl font-bold text-secondary text-left mb-6">
          Saved Itineraries
        </h2>

        <div
          id="popular-destination"
          className="flex flex-wrap m-8 gap-8 md:gap-24"
        >
